...
@module("./useOtherObs.js")
external useObserver: Observer.t<'a> = "default"

@module("./useOtherObs.js")
external useOtherObservable: Observable.t<'a, 'error> => Observable.t<'t, 'error> = "default"

// open Observable
// useOtherObservable.subscribe(
//   ~onNext=result => Js.log2("watchQuery To-Dos: ", result),
//   ~onError=result => Js.log2("watchQuery To-Dos: ", result),
//   ~onComplete=() => Js.log("watchQuery To-Dos: "),
//   (),
//   _,
// )

// useOtherObservable|>Observable.fromJs
useObserver|>ignore
