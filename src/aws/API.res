...
@bs.send
external _graphql: (t, Types.graphqlOperation) => Js.Promise.t<Types.executionResult> = "graphql"

let mutate: Types.operation = graphqlOperation => _graphql(api, graphqlOperation)
...
) => Wonka_observable.observableT<Types.observableLike<Types.observerLike<'value>>> = "graphql"
